  ...
  if (job.logo) {
    return (
      ...
      <img
        src={job.logo}
        alt={`${job.company} 로고`}
        className="size-11 rounded-xl border border-neutral-200 bg-white object-contain p-1.5"
      />
    );
  }

  return (
    <div className="flex size-11 items-center justify-center rounded-xl bg-neutral-100 text-sm font-bold text-neutral-500">
