      ...
      <div className="space-y-3">
        <label className="block">
          ...
          <input
            ...
            maxLength={120}
            className="draft-editor-field w-full rounded-xl border border-neutral-200 bg-white px-3 py-2.5 text-sm font-semibold text-neutral-900 outline-none ring-brand/30 transition placeholder:text-neutral-400 focus:ring-2 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100 dark:placeholder:text-neutral-500"
          />
        </label>
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={20}
            spellCheck={false}
            className="draft-editor-field w-full resize-y rounded-xl border border-neutral-200 bg-white px-3 py-3 font-mono text-[13px] leading-[1.75] text-neutral-900 outline-none ring-brand/30 transition placeholder:text-neutral-400 focus:ring-2 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-100 dark:placeholder:text-neutral-500"
          />
        </label>
      </div>
