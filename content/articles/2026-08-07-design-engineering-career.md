...
summary: "• ‘디자이너는 코딩을 배워야 하나’라는 이분법 대신, 서로의 분야에서 어떤 역량을 배울지 묻는 글
...
Adobe에는 고해상도 프로토타이핑을 별도 분야로 맡는 디자인 엔지니어와 매니저가 20명 넘게 있다. 이 팀은 디자이너와 UX 리서처와 함께 문제를 이해하고, 프로토타입을 설계·구현한 뒤 실제 사용자에게 테스트한다. 배운 내용을 디자인에 반영하고 다시 만들고 검증하는 과정을 반복함.
