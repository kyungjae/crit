---
title: "AI가 쉽게 만들어주는 시대에도, 눈과 손은 길러야 한다 — 딸에게 보내는 편지"
summary: "Julie Zhuo가 11살 딸에게 보낸 편지입니다. AI가 결과물을 빠르게 만드는 시대에도 무엇이 뛰어난지 알아보는 눈과, 직접 만들고 실패하며 익히는 손은 따로 훈련해야 한다고 말합니다."
category: ai-design
format: deep
...
> Julie Zhuo가 11살 딸에게 몇 달 전 건넨 편지다. AI가 쉽게 결과물을 만들어주는 시대에도, 좋은 것을 알아보는 눈과 직접 만들어보는 손은 계속 길러야 한다는 이야기.
...
> 창의적인 일을 하는 사람들은 모두 좋은 취향을 가지고 있기 때문에 그 일을 시작한다. 하지만 간극이 있다. 처음 몇 년 동안 만드는 것은 그다지 좋지 않다. 좋아지려고 하고, 가능성도 있지만, 아직은 그렇지 않다. 그런데 게임에 들어오게 만든 바로 그 취향은 여전히 대단하다. 그리고 자신의 작업이 실망스러운 이유도 바로 그 취향 때문이다.
...
이 편지는 AI를 쓰지 말자는 주장이 아니다. 만화 시리즈처럼 속도와 비용이 분명한 목표가 있다면 AI를 쓰는 편이 합리적이라고 인정한다. 다만 결과물을 만드는 능력과 그것을 판단하는 능력은 같은 방식으로 길러지지 않는다고 말한다.

여기서 ‘손’은 꼭 연필이나 바늘을 쥐는 행위만 뜻하지 않는다. 결과가 나오기 전까지 여러 번 시도하고, 실패한 이유를 확인하고, 다시 고치는 과정에 가깝다. AI로 캐릭터와 스타일을 탐색하는 일도 그 과정을 포함한다면 손의 훈련이 될 수 있다. 반대로 생성 버튼을 누르고 결과를 고르는 일만 반복한다면, 손뿐 아니라 눈도 충분히 쓰지 않는 셈이다.

## 다르게 볼 부분

- 직접 만드는 시간이 판단력을 키우는 데 도움이 된다는 점과, 반드시 손으로 만들어야 한다는 점은 다르다. AI를 이용한 실험에서도 실패의 원인을 추적하고 수정한다면 다른 형태의 ‘손’이 생길 수 있다.
- ‘좋은 취향’이 넓은 감상과 숙련에서 나온다는 주장은 설득력 있지만, 무엇을 탁월하다고 부를지는 시대와 공동체에 따라 달라진다. 많이 보고 오래 연습하는 것만으로 하나의 기준이 보장되지는 않는다.

## 남는 질문

- AI가 만든 두 결과물 중 더 나은 것을 구분하려면 반드시 직접 손으로 만드는 시간이 필요한가. 필요하다면 어느 정도의 경험이 필요한가.
- AI를 이용한 반복과 실험이 ‘손’의 훈련이 될 수 있다면, 사람이 직접 해야 하는 작업과 맡겨도 되는 작업의 경계는 어디에 있는가.
