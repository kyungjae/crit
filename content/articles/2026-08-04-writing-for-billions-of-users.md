...
Nick DiLallo는 소수의 사용자가 쓰는 제품과 지구의 의미 있는 비율이 사용하는 제품을 모두 경험한 뒤, 후자가 전자에게는 가르쳐주지 못한 것을 가르쳤다고 말합니다. 수십 개 언어, 시간대, 문화권의 수십억 사용자를 위한 글쓰기에서 얻은 메모입니다.
...
이 원칙들의 공통점은 “문구를 더 잘 쓰자”보다 “문구가 맡은 일을 정확히 보자”에 있습니다. 어떤 오류 메시지는 근본 원인을 고치면 사라지고, 어떤 안내문은 사진이나 지도 같은 다른 정보 형태가 더 잘 설명합니다. 어떤 전환율 개선 문구는 제품의 기만을 감추는 장치가 될 수 있음.
...
- 조언은 풍부하지만, 서로 충돌하는 원칙 사이의 우선순위는 제시하지 않음.
