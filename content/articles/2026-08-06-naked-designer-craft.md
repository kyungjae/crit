...
이 글의 핵심은 ‘AI가 디자이너의 손을 빼앗는다’는 데 있지 않다. 결과물을 만들었다는 사실만으로는 더 이상 의도와 판단을 증명할 수 없다는 데 있다. 다만 ‘할 말이 있는 사람’이라는 기준은 모호하다. 모든 디자인이 개인의 독창적인 관점을 먼저 요구하는 것은 아니며, 많은 작업은 다른 사람의 조건을 이해하고 합의된 목표 안에서 실패를 줄이는 일이다. 그 경우에도 의미 있는 작업이 반드시 거대한 메시지를 가져야 하는지는 원문이 답하지 않는다.
