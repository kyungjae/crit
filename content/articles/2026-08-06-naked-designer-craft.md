...
AI는 디자이너의 손을 빼앗기보다, 결과물이 실력과 의도를 대신 증명해주던 시대를 끝낸다. 이제 중요한 건 무엇을 만들었는지가 아니라 왜 그것을 골랐는지다. 다만 관점만으로 품질과 책임을 검증할 수는 없고, ‘할 말이 있다’는 기준이 말 잘하는 사람에게 유리한 포장으로 끝나지 않으려면 채용과 디자인 리뷰에서 이를 어떻게 확인할지 남는다.
